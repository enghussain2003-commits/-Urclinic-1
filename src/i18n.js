...
const resources = {
  en: {
    translation: {
      ...
      patient_call_sent_short: "Called",
      ...
      patient_call_sound: "Patient call sound",
      patient_call_sound_desc: "Play a short local chime when reception receives a patient call.",
      enabled: "Enabled",
      disabled: "Disabled",
  ...
  ar: {
    translation: {
      ...
      call_patient: "استدعاء المريض",
      patient_call: "استدعاء مريض",
      patient_call_sent_short: "تم الاستدعاء",
      ...
      patient_call_sound: "صوت استدعاء المريض",
      patient_call_sound_desc: "تشغيل نغمة محلية قصيرة عند وصول استدعاء مريض إلى الاستقبال.",
      enabled: "مفعّل",
      disabled: "معطّل",
